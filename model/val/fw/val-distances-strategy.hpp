...
private:
    ...
    virtual void
    doSendZeroData(const std::shared_ptr<const dfnt::Entry>& dfntEntry, const ndn::Data& data) override;


    virtual void
    doUnsolisitedData (const std::shared_ptr<const dfnt::Entry>& dfntEntry, const ndn::Data& data) override;
    /**
