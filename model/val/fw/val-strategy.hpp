...
public:
     ...
     */
    void
    setMobilityModel(Ptr<ns3::MobilityModel> mobilityModel)
    {
    ...
    void
    sendZeroData(const std::shared_ptr<const dfnt::Entry>& dfntEntry, const ndn::Data& data)
    {
        this->doSendZeroData(dfntEntry, data);
    }

    void
    unsolisitedData (const std::shared_ptr<const dfnt::Entry>& dfntEntry, const ndn::Data& data)
    {
      this->doUnsolisitedData (dfntEntry, data);
    }
...
protected:
    ...
    virtual void
    doSendZeroData(const std::shared_ptr<const dfnt::Entry>& dfntEntry, const ndn::Data& data) = 0;

    virtual void
    doUnsolisitedData(const std::shared_ptr<const dfnt::Entry>& dfntEntry, const ndn::Data& data) = 0;
...
protected:
    ...
    static constexpr long int SIGNAL_RANGE = 80;      // in meters
...
private:
    ...
    Ptr<ns3::MobilityModel> m_mobilityModel;
};
