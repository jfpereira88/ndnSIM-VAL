...
public: // signals
  ...
  // #########  new signals for LAL support
  
  /** \brief fires after a geoface is added
   * 
   *  jfp - uminho - mieti - 2019
   */
  signal::Signal<FaceTable, Face&> afterValFaceAdd;

  /** \brief fires before a geoface is removed
   * 
   * When this signal is emitted, face is still in FaceTable and has valid FaceId.
   *  jfp - uminho - mieti - 2019
   */
  signal::Signal<FaceTable, Face&> beforeValFaceRemove;
